...
Current scale: **588 source + header files, ~101K lines of C, ~42K lines of tests, 2999 tests, 32 channels**.
...
5. **All 2,985+ tests must pass at zero ASan errors**
...
tests/                 92 test files, 2,985+ tests
