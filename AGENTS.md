...
Current scale: **~500+ source + header files, ~78K+ lines of C, ~30K+ lines of tests, 2,487 tests**.
...
5. **All 2,487+ tests must pass at zero ASan errors**
...
tests/                 84 test files, 2,487 tests
