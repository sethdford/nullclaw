...
public enum SCTokens {
    ...
    public enum Light {
        ...
        public static let accentLight = Color(hex: 0xCCFBF1)
        ...
        public static let accentSubtle = Color(red: 0.051, green: 0.5804, blue: 0.5333, opacity: 0.08)
        ...
        public static let accentText = Color(hex: 0x0F766E)
        public static let backdropOverlay = Color(red: 0, green: 0, blue: 0, opacity: 0.3)
        public static let bg = Color(hex: 0xF0F5FA)
        public static let bgElevated = Color(hex: 0xECF2F8)
        public static let bgInset = Color(hex: 0xE6EDF4)
        public static let bgOverlay = Color(hex: 0xFFFFFF)
        public static let bgSurface = Color(hex: 0xFFFFFF)
        public static let bgWarm = Color(hex: 0xF7F9FC)
        public static let border = Color(hex: 0xC0D0E0)
        public static let borderSubtle = Color(hex: 0xD8E4F0)
        ...
        public static let text = Color(hex: 0x0B1219)
        public static let textFaint = Color(hex: 0x5E7A94)
        public static let textMuted = Color(hex: 0x3D5468)
