...
object SCTokens {
    ...
    object Light {
        ...
        val accentLight = Color(0xFFCCFBF1)
        ...
        val accentSubtle = Color(0x140D9488)
        ...
        val bg = Color(0xFFF0F5FA)
        val bgElevated = Color(0xFFECF2F8)
        val bgInset = Color(0xFFE6EDF4)
        val bgOverlay = Color(0xFFFFFFFF)
        val bgSurface = Color(0xFFFFFFFF)
        val bgWarm = Color(0xFFF7F9FC)
        val border = Color(0xFFC0D0E0)
        val borderSubtle = Color(0xFFD8E4F0)
        ...
        val text = Color(0xFF0B1219)
        val textFaint = Color(0xFF5E7A94)
        val textMuted = Color(0xFF3D5468)
