...
```
~561 KB binary · <30 ms startup · 3327+ tests · 50+ providers · 33 channels · 66+ tools · Pluggable everything
```
...
Tests:         3327 passing, 0 ASan errors
```
...
tests/ 113 test files, 3327 tests
