...
```
~561 KB binary · <30 ms startup · 3320+ tests · 50+ providers · 33 channels · 66+ tools · Pluggable everything
```
...
Tests:         3320 passing, 0 ASan errors
```
...
tests/ 102 test files, 3320 tests
