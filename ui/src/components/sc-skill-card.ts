      ...
      >
        <div class="skill-card-inner">
          <div class="skill-header">
            ...
            ${isInstalled
              ? html`<sc-badge variant=${inst.enabled ? "success" : "neutral"}
                  >${inst.enabled ? "Enabled" : "Disabled"}</sc-badge
                >`
              : reg.version
                ? html`<sc-badge variant="info">${reg.version}</sc-badge>`
                : nothing}
          </div>
          ...
          <div class="skill-footer">
            <div class="skill-tags">
              ${this.variant === "registry"
                ? parseTags(reg.tags).map((t) => html`<sc-badge variant="neutral">${t}</sc-badge>`)
                : nothing}
            </div>
            ${isInstalled
              ? html`<sc-switch
